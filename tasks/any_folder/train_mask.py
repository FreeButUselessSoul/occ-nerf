...
from dataloader.with_mask import DataLoaderAnyFolder
...
def train_one_epoch(scene_train, optimizer_nerf, optimizer_focal, optimizer_pose, model, focal_net, pose_param_net,
    ...
    for i in ids:
        ...
        mask = scene_train.masks[i].to(my_devices)
        ...
        # else:
        L2_loss = torch.mean(mask_selected * (rgb_rendered - img_selected)**2)
